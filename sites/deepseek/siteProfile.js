(function initDeepSeekSiteProfile(globalScope) {
  ...
  const DEFAULT_DEEPSEEK_SITE_PROFILE = {
    ...
    selectors: {
      ...
      sendButton: "button[type='submit'], button[aria-label*='Send' i], [role='button'][aria-label*='Send' i], [role='button'].ds-icon-button, .ds-icon-button[role='button']",
      fileAttachedIndicator: "[data-testid*='attachment' i], [class*='attach' i], [class*='upload' i]",
      fileNameIndicator: "*",
      fileTypeIndicator: "*",
      sendButtonDisabledIndicator: "button[disabled][type='submit'], button[aria-disabled='true'], [role='button'][aria-disabled='true'], .ds-icon-button--disabled[role='button'], [role='button'].ds-icon-button--disabled",
