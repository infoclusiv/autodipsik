(function initGatewayFileService(globalScope) {
  ...
  function saveDeepSeekResponseJson(input) {
    return NewSiteBackground.GatewayPersistenceService.saveDeepSeekResponseJson(input);
  }

  function saveDeepSeekWorkflowRunJson(input) {
    return NewSiteBackground.GatewayPersistenceService.saveDeepSeekWorkflowRunJson(input);
  }

  function saveDeepSeekWorkflowAhkFile(input) {
    return NewSiteBackground.GatewayPersistenceService.saveDeepSeekWorkflowAhkFile(input);
  }
