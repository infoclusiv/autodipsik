(function initTelemetryEventConstants(globalScope) {
  ...
  NewSiteCore.DeepSeekTelemetryEvents = {
    ...
    CONDITIONAL_WORKFLOW_BATCH_STARTED: "automation.conditional_workflow.batch.started",
    ...
    CONDITIONAL_WORKFLOW_BATCH_COMPLETED: "automation.conditional_workflow.batch.completed",
    CONDITIONAL_WORKFLOW_BATCH_FAILED: "automation.conditional_workflow.batch.failed",
